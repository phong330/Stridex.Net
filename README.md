...
Project này bám theo mức bài thực hành C#/.NET cơ bản: không dùng microservices, Docker, Kubernetes hay các kỹ thuật quá nâng cao. Mục tiêu là chạy được, có CRUD, có giỏ hàng, có đặt hàng và có quản trị.
